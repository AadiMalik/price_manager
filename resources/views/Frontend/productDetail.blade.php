        ...
        <div class="container">
            <div class="section-header">
                <h2>{{$user->UserType->name}}</h2>
                                            ...
                                            <div class="alert collapse" id="collapseExample" style=" 
    font-size: 25px;
    text-align: center;
    font-weight: bold;
    color: #fff;
                ...
                <div class="col-lg-11">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12" style="text-align:right;">
                            <img class="img-thumbnail" style="width:100%; height:350px;" src="{{$user->image_url ? asset($user->image_url) : asset('asset/img/portfolio-1.jpg')}}"/>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><b>@auth 
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<button id="butsave" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="font-size: 12px; color: #fff; height: 30px; line-height: 10px;">Show</button> @else &nbsp;&nbsp;&nbsp;&nbsp;Login First then Show @endauth</b>
                ...
                <div class="col-lg-11 mb-3">
                    <nav>
                        <ul>
                            ...
                            <li><a @if (Request::is('package/'.$user->id.'/0')) class="link_active" @endif href="{{url('package/'.$user->id.'/0')}}">All</a></li>
                            @foreach($productcategory as $item)
                            @if($item->name!=null)
                            <li><a @if (Request::is('package/'.$user->id.'/'.$item->id)) class="link_active" @endif href="{{url('package/'.$user->id.'/'.$item->id)}}">{{$item->name}}</a></li>
                            @endif
                            @endforeach
                    ...
                    <div class="row">
                        ...
                        @foreach($product as $index => $product)
                            <div class="col-lg-2 col-md-4 col-sm-6 popup" style="margin-bottom:20px;">
                                <a data-toggle="modal" data-target="#packageDetail{{$index+1}}" href="#">
									<div class="card" style="border-radius: 0%; background: none; border:none;">
									  <div class="card-body" style="padding: 0px;">
										<div class="row">
											<div class="col-md-12">
												<img style="height: 250px; width:100%; border-radius:0px; box-shadow: 0px 0px 10px 0px #808080;" src="{{asset($product->image_url)}}"/>
											</div>
										</div>
										
										<div class="row" style="padding-left:5px; margin-top:10px;">
											<div class="col-md-12" style="width:100%;text-overflow: ellipsis;
    overflow: hidden;
    white-space: nowrap;">
												<b>{{$product->name}}</b><br>
												<b  style="color:#da5c22;">{{number_format($product->price)}} <small>PKR</small></b>&nbsp;&nbsp;&nbsp;@if($product->pre_price!=null)<small><del>{{number_format($product->pre_price)}}PKR</del></small>@endif
											</div>
										</div>
                                ...
                                <div class="modal-dialog" style="width:100%; padding:17px;">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background:#da5c22; padding:5px 1rem;">
                                            <h5 class="modal-title" style="color:#fff; font-size:25px;" id="exampleModalLabel">{{$user->name}}</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-6" class="img-thumbnail" style="background-image:url('{{asset($product->image_url)}}');width:100%; text-align:center; height:600px; background-size: contain; background-position: center; background-repeat: no-repeat;">
                                                    ...
                                                    <div class="row" style="margin-top:15px;">
                                                        <div class="col-lg-12">
                                                            <span class="badge"
                                                                ...
                                                                <i
                                                                        style="font-size:12px;">PKR</i><br>
                                                                        @if($product->pre_price!=null)<small style="font-size:20px; float:right;"><del>{{number_format($product->pre_price)}}&nbsp;&nbsp;PKR</del></small>@endif
                                                                        </span>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6" style="margin-top:5px;">
                                ...
                                <a data-toggle="modal" data-target="#ImageModel{{$index+1}}" href="#">
                                    <img class="img-thumbnail" title="{{$imageRemark->name}}"
                                         src="{{asset($imageRemark->image_url)}}" style="height:200px; width:100%;"/>
                                </a>
                            </div>
                            <div class="modal fade modal-fullscreen" id="ImageModel{{$index+1}}" style="padding-right:90px;"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" style="width:100%; padding:17px;">
                                    <div class="modal-content">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <fieldset class="rating">
                                        <input type="radio" id="star5" name="rating"
                                               value="5"/><label class="full" for="star5" title="Awesome - 5 stars"></label> <input
                                                type="radio"
                                                id="star4half"
                                                name="rating"
                                                value="4.5"/><label
                                        ...
                                        <input
                                                type="radio" id="star4" name="rating" value="4"/><label class="full"
                                                                                                        for="star4"
                                        ...
                                        <input type="radio" id="starhalf" name="rating" value="0.5" required="required"/>
                                        <label class="half"
                                                                                                            for="starhalf"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="media">
                                    ...
                                    <img class="mr-3" src="{{asset($review->reviewUser->image_url)}}" style="width:70px; height:70px;" alt="Generic placeholder image">
                                    @else
                                    <i class="fa fa-user" style="font-size:20px; margin-right:15px;"></i>
                                    @endif
                                    <div class="media-body">
                                        <h5 class="mt-0">{{$review->reviewUser->name}} <span style="font-size:14px; float:right;">{{date('d-M-y', strtotime($review->created_at))}}</span></h5>
