    ...
    <div class="feature-top">
        <div class="container-fluid">
            <div class="row" style="height:100%;">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="feature-item" style="padding:0px;">
                        <img src="{{asset('asset/img/reliability.png')}}" style="width: 70px; height: 70px;border-radius: 50%;">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="feature-item" style="padding:0px;">
                        <img src="{{asset('asset/img/accessibility.png')}}" style="width: 70px; height: 70px;border-radius: 50%;">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="feature-item" style="padding:0px;">
                        <img src="{{asset('asset/img/support.png')}}" style="width: 70px; height: 70px;border-radius: 50%;">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="feature-item" style="padding:0px;">
                        <img src="{{asset('asset/img/honesty.png')}}" style="width: 70px; height: 70px;border-radius: 50%;">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="feature-item" style="padding:0px;">
                        <img src="{{asset('asset/img/quality.png')}}" style="width: 70px; height: 70px;border-radius: 50%;">
    ...
    <div class="container">
            ...
            <div class="row">
                <table style="width:100%;">
                    ...
                    <td style="width:25%;">
                        <select class="js-example-basic-single form-control" style="width:100%;" name="user_type" id="user_type">
                    ...
                    <td style="width:25%;">
                        <select class="js-example-basic-single form-control" style="width:100%;" name="industry" id="industry">
                            <option value="all">All</option>
                    ...
                    <td style="width:25%;">
                        <select class="js-example-basic-single form-control" style="width:100%;" name="city" id="city">
                        <option value="all">All</option>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <a href="{{route('frontendUserPackageDetail',$user)}}">
                                                <div class="service-item">
                                                    ...
                                                    <h3 style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; width:100%;text-transform:capitalize;"> @if($user->verify==1) <span style="
                                                        color: blue;
                                ...
                                <div class="item">
                                    <div class="pad15">
                                        <a href="{{route('frontendUserPackageDetail',$user->id)}}">
                                            ...
                                            <div>
                                                <span style="text-align:left; display: inline-block; font-size:14px;">{{$user->name}}</span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        $.each(response.data, function (value, index) {
                            ...
                            var imageUrl = URL ;
                            var imageUrl = index.image_url !=null ? index.image_url : 'asset/img/portfolio-1.jpg';
                            ...
                            if (productLength > 0) {
                                ...
                                if (isNaN(rating) || rating < 0.5 ) {
                                    RatingDisplay += '<span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                } else if(rating < 1) {
                                    RatingDisplay += '<span class="fa fa-star-half-alt" style="color:#da5c22;"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                }
                                else if(rating < 1.5) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                }
                                else if(rating < 2) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star-half-alt" style="color:#da5c22;"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                }
                                else if(rating < 2.5) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                }
                                else if(rating < 3) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star-half-alt" style="color:#da5c22;"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                }
                                else if(rating < 3.5) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star"></span><span class="fa fa-star"></span>'
                                }else if(rating < 4) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star-half-alt" style="color:#da5c22;"></span><span class="fa fa-star"></span>'
                                }else if(rating < 4.5) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star"></span>'
                                }
                                else if (rating < 5) {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"><span class="fa fa-star-half-alt" style="color:#da5c22;"></span>'
                                }
                                 else {
                                    RatingDisplay += '<span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"></span><span class="fa fa-star" style="color:#da5c22;"><span class="fa fa-star" style="color:#da5c22;">'
                                ...
                                html += '<div class="col-lg-3 col-md-6 col-sm-12 remove"> \n' +
                                    ...
                                    '                                                <div class="service-icon item">\n' +
                                    '                                                    <span class="notify-badge">' + cityName + '</span>\n' +
                                    '                                                    <img src="' + imageUrl +'" />\n' +
                                    '                                                </div>\n' +
                                    '                                                <div class="row">\n' +
                                    '                                                    <div class="col-lg-12">\n' +
                                ...
                                setTimeout(function () {
                                    ...
                                    $.each(index.products, function (index, product) {
                                        if (product.price == 0) {
                                            ...
                                            productData += '<tr><td scope="col" style="text-align:left;"><p class="size">' + (index + 1) + '</p></td><td scope="col" style="text-align:left; overflow:hidden !important;"> <p class="cut-text size">' + product.name + '</p></td><td scope="col" style="text-align:left; font-size:14px; overflow:hidden !important;"><p class="cut-text size">' + product.quality + '</p></td><td scope="col" style="text-align:right;"><p class="size">' + product.price + '</p></td></tr>'
                                        }
                                    })
                                    productData += '</tbody>'
