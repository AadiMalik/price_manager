                    ...
                    <div class="shopping-cart" style="margin-top:30px;">
                        ...
                        <div class="product">
                            <div class="product-image">
                                <img src="{{$item->product_name->image1??'https://s.cdpn.io/3/dingo-dog-bones.jpg'}}">
                            </div>
                            <div class="product-details">
                                <div class="product-title" style="font-weight: bold;">{{$item->product_name->name??''}}</div>
                                <p class="product-description">{{$item->product_name->category_name->name??''}}</p>
                            </div>
                            ...
                            <div class="product-line-price">{{$item->product_name->price * $item->qty??'1'}}</div>
                        </div>
                        @php
                        ...
                        <div class="totals">
                            ...
                            <div class="totals-item totals-item-total">
                                ...
                                <div class="totals-value" style="font-weight: bold;" id="cart-total">{{$total}}</div>
                            </div>
                        </div>
