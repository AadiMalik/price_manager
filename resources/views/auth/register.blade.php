                ...
                <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="wrap-input100 validate-input" data-validate = "Enter username">
                                <input class="input100" type="text" name="name" placeholder="Username" value="{{ old('name') }}" autocomplete="off"  >
                                @error('name')
                            ...
                            <div class="wrap-input100 validate-input" data-validate = "Enter Phone No">
                                <input class="input100" type="number" name="phone" placeholder="Phone No" value="{{ old('phone') }}" autocomplete="off"  >
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Enter password">
                                <select class="input100"  name="type">
                                    ...
                                    <option value="{{$userType->id}}" {{old('type') == $userType->id ? 'selected' : ''}}>{{$userType->name}}</option>
                                    @endforeach
                                </select>
                                @error('type')
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="contact100-form-checkbox">
                        ...
                        <label class="label-checkbox100" for="ckb1">
                            ...
                            <p style="text-align:center; color:#fff;">By clicking Register, you agree to our <a href="{{url('fterm')}}" style="color: #df7644;">Terms and Condition.</a></p><br>
