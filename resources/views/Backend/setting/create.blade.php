            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="{{route('settingStore')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" value="{{old('value')}}" class="form-control {{ $errors->has('value') ? 'has-error' : '' }}" name="value" required>
