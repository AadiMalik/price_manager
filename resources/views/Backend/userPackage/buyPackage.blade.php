    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body" style="height: 185px;">
                            <form id="form_advanced_validation" method="POST" action="{{route('storeBuyPackage',$package->id)}}" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="card">
                        <div class="header" style="background:#f44336;">
                            <h2 style="color:#fff;">Selected Pckage Detail</h2>
                        </div>
                        <div class="body">
                            <table class="table bordered-table">
                                ...
                                <tr>
                                    <td>Package Price:</td>
                                    <td><b>{{number_format($package->price)}}</b></td>
                                </tr>
                                <tr>
                                    <td>Validity days:</td>
                                    <td><b>{{$package->validity_day}}</b></td>
                                </tr>
                            </table>
                        </div>
                    </div>
