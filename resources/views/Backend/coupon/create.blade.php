            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="{{route('coupon.store')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" value="{{old('amount')}}" class="form-control {{ $errors->has('amount') ? 'has-error' : '' }}" name="amount" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="datetime-local" value="{{old('expiry')}}" class="form-control {{ $errors->has('expiry') ? 'has-error' : '' }}" name="expiry" required>
