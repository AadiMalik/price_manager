            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="{{route('updateUserProfile')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" value="{{$user->name,old('name')}}" class="form-control {{ $errors->has('name') ? 'has-error' : '' }}" name="name" disabled>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control {{ $errors->has('first_name') ? 'has-error' : '' }}" value="{{$user->first_name,old('first_name')}}" name="first_name" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control {{ $errors->has('last_name') ? 'has-error' : '' }}" value="{{$user->last_name,old('last_name')}}" name="last_name" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control {{ $errors->has('address') ? 'has-error' : '' }}" value="{{  $user->address,old('address')}}" name="address" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" class="form-control {{ $errors->has('phone_no') ? 'has-error' : '' }}" value="{{ $user->phone_no,old('phone_no')}}" name="phone_no" maxlength="11" disabled>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea class="form-control {{ $errors->has('description') ? 'has-error' : '' }}" value="{{ $user->description}}" name="description" required>{{ $user->description}}</textarea>
