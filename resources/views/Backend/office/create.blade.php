            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="{{route('officeStore')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control {{ $errors->has('phone_no') ? 'has-error' : '' }}" value="{{old('phone_no')}}" name="phone_no" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="email" class="form-control {{ $errors->has('size') ? 'has-error' : '' }}" value="{{old('email')}}" name="email" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input spellcheck="true" type="text" class="form-control {{ $errors->has('description') ? 'has-error' : '' }}" value="{{  old('description')}}" name="description" required>
