            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="{{route('payment.store')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" value="{{old('bank')}}" class="form-control {{ $errors->has('bank') ? 'has-error' : '' }}" name="bank" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" value="{{old('account_no')}}" class="form-control {{ $errors->has('account_no') ? 'has-error' : '' }}" name="account_no" required>
